...
> = {
  ja: {
    ...
    "/apps/inbox-triage": { title: "Jev AI メール仕分け：6 件のサンプルを試す", description: "Jev で架空のメール 6 件を返信・確認・後で読むに仕分け、自分の 1 件も試せます。Gmail 接続不要。" },
  ...
  fr: {
    ...
    "/apps/inbox-triage": { title: "Tri des e-mails avec Jev AI : démo gratuite", description: "Classez six e-mails fictifs avec Jev, puis essayez un message personnel. Sans compte ni connexion Gmail." },
  ...
  pl: {
    ...
    "/apps/inbox-triage": { title: "Sortowanie poczty z Jev AI: wypróbuj demo", description: "Posortuj sześć fikcyjnych e-maili z Jev i wypróbuj jedną własną wiadomość. Bez rejestracji i Gmaila." },
