...
const en: InboxTriageCopy = {
  ...
  demoStep: "01 / DEMO",
  customStep: "02 / YOUR EMAIL",
  inboxCount: "INBOX / 06",
  liveResultLabel: "JEV / RESULT",
  previewResultLabel: "SAMPLE / PREVIEW",
  ...
  noReply: "This tool only sorts and flags messages. It does not write or send email replies.",
...
export const INBOX_TRIAGE_COPY: Record<Locale, InboxTriageCopy> = {
  ...
  zh: {
    ...
    demoStep: "01 / 示例邮件", customStep: "02 / 你的邮件", inboxCount: "邮件 / 06", liveResultLabel: "JEV / 分析结果", previewResultLabel: "示例 / 预览",
    ...
    resultTitle: "建议队列", resultDescription: "这些只是供你检查的建议。我们不会移动、删除或发送任何邮件。", loading: "Jev 正在整理…", error: "请求未能完成。", retry: "重试", details: "查看判断信号", typeLabel: "邮件类型", replyLabel: "直接回复请求", timeLabel: "时间紧迫度", typeConfidence: "类型判断置信度", timeConfidence: "时间判断置信度", noReply: "这里只建议邮件分类，不会代你撰写或发送回复。",
